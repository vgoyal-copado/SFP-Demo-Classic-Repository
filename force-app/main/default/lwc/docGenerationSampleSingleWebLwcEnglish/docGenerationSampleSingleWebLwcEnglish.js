...
import { OMNIDEF } from './docGenerationSampleSingleWebLwcEnglish_def.js';
import tmpl from './docGenerationSampleSingleWebLwcEnglish.html';
import tmpl_nds from './docGenerationSampleSingleWebLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenerationSampleSingleWebLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
