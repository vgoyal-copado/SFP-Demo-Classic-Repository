import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    ...
    import {interpolateWithRegex, interpolateKeyValue, loadCssFromStaticResource } from "vlocity_cmt/flexCardUtility";
        ...
        CPQMultisiteGridCardNoResultMessageLabel:"After you set up objects for grouping, like premises or service accounts, you'll find them here.",
        CPQMultisiteGridCardNoResultLabel:"You’ve nothing to group!"
        };
              pubsubEvent = [];
              customEvent = [];
