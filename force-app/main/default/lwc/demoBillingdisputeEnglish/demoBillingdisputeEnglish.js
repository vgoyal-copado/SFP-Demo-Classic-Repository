...
import { OMNIDEF } from './demoBillingdisputeEnglish_def.js';
import tmpl from './demoBillingdisputeEnglish.html';
import tmpl_nds from './demoBillingdisputeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoBillingdisputeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
