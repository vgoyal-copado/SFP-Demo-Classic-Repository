...
import { OMNIDEF } from './cPQBulkReplaceMultiLanguage_def.js';
import tmpl from './cPQBulkReplaceMultiLanguage.html';
import tmpl_nds from './cPQBulkReplaceMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cPQBulkReplaceMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
