import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfDemoUpdateContactCommunicationForm extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @track omniSupportKey = 'cfDemoUpdateContactCommunicationForm';
              @track record;
              ...
              registerPubSub() {
                pubsub.register('NOTIFICATIONMC', {
                          updateos: this.handleEventAction.bind(this, data.events[0],0)
                      });
