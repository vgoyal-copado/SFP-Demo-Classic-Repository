...
import { OMNIDEF } from './clmAsyncQuoteToContractEnglish_def.js';
import tmpl from './clmAsyncQuoteToContractEnglish.html';
import tmpl_nds from './clmAsyncQuoteToContractEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class clmAsyncQuoteToContractEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
