...
import { OMNIDEF } from './demoInternetSelfInstallEnglish_def.js';
import tmpl from './demoInternetSelfInstallEnglish.html';
import tmpl_nds from './demoInternetSelfInstallEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoInternetSelfInstallEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
