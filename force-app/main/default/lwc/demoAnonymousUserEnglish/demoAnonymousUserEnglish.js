...
import { OMNIDEF } from './demoAnonymousUserEnglish_def.js';
import tmpl from './demoAnonymousUserEnglish.html';
import tmpl_nds from './demoAnonymousUserEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoAnonymousUserEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
