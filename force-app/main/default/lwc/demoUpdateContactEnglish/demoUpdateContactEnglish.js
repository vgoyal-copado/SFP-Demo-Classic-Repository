...
import { OMNIDEF } from './demoUpdateContactEnglish_def.js';
import tmpl from './demoUpdateContactEnglish.html';
import tmpl_nds from './demoUpdateContactEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoUpdateContactEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
