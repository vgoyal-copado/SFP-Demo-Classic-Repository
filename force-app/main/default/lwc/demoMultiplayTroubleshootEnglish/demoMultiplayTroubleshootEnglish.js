...
import { OMNIDEF } from './demoMultiplayTroubleshootEnglish_def.js';
import tmpl from './demoMultiplayTroubleshootEnglish.html';
import tmpl_nds from './demoMultiplayTroubleshootEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoMultiplayTroubleshootEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
