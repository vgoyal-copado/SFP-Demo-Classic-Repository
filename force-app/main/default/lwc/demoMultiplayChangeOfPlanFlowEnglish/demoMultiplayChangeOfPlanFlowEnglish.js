...
import { OMNIDEF } from './demoMultiplayChangeOfPlanFlowEnglish_def.js';
import tmpl from './demoMultiplayChangeOfPlanFlowEnglish.html';
import tmpl_nds from './demoMultiplayChangeOfPlanFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoMultiplayChangeOfPlanFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
