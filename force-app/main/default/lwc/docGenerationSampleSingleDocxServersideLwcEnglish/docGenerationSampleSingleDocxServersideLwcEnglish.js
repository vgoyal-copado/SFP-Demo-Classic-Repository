...
import { OMNIDEF } from './docGenerationSampleSingleDocxServersideLwcEnglish_def.js';
import tmpl from './docGenerationSampleSingleDocxServersideLwcEnglish.html';
import tmpl_nds from './docGenerationSampleSingleDocxServersideLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenerationSampleSingleDocxServersideLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
