...
import { OMNIDEF } from './docGenerationSampleMultiPDFConvertLwcEnglish_def.js';
import tmpl from './docGenerationSampleMultiPDFConvertLwcEnglish.html';
import tmpl_nds from './docGenerationSampleMultiPDFConvertLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenerationSampleMultiPDFConvertLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
