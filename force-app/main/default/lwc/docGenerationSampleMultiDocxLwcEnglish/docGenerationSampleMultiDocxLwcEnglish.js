...
import { OMNIDEF } from './docGenerationSampleMultiDocxLwcEnglish_def.js';
import tmpl from './docGenerationSampleMultiDocxLwcEnglish.html';
import tmpl_nds from './docGenerationSampleMultiDocxLwcEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenerationSampleMultiDocxLwcEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
