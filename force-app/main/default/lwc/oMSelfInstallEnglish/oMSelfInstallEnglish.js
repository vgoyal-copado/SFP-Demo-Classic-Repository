...
import { OMNIDEF } from './oMSelfInstallEnglish_def.js';
import tmpl from './oMSelfInstallEnglish.html';
import tmpl_nds from './oMSelfInstallEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class oMSelfInstallEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
