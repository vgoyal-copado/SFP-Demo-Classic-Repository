import { FlexCardMixin } from "vlocity_cmt/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels } from "vlocity_cmt/flexCardUtility";
          ...
          export default class cfDemoAccountAssetDetailStatementsCurrent_8_DE extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @track omniSupportKey = 'cfDemoAccountAssetDetailStatementsCurrent_8_DE';
              @track record;
              ...
              registerPubSub() {
                pubsub.register('StatementMC', {
                          setvalues: this.handleEventAction.bind(this, data.events[0],0)
                      });
