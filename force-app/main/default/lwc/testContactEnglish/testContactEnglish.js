...
import { OMNIDEF } from './testContactEnglish_def.js';
import tmpl from './testContactEnglish.html';
import tmpl_nds from './testContactEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testContactEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
