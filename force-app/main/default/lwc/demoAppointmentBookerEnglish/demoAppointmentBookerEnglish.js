...
import { OMNIDEF } from './demoAppointmentBookerEnglish_def.js';
import tmpl from './demoAppointmentBookerEnglish.html';
import tmpl_nds from './demoAppointmentBookerEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class demoAppointmentBookerEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
