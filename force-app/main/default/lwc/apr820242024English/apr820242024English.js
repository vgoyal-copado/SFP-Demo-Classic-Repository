...
import { OMNIDEF } from './apr820242024English_def.js';
import tmpl from './apr820242024English.html';
import tmpl_nds from './apr820242024English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class apr820242024English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
